...
router.post('/users/user-panel', authorize('admin'), validate(userPanelSchema), adminController.createUserPanel);
...
router.patch('/branches/:id/toggle-status', authorize('admin'), adminController.toggleBranchStatus);
router.patch('/branches/:id/restore', authorize('admin'), adminController.restoreBranch);
